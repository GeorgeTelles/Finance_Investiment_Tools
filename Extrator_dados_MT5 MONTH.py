...
def extrair_dados():
    ...
    for ativo in ativos:
        try:
            calcular_resultados_mensais(ativo, dataini, writer)
...
def calcular_resultados_mensais(ativo, dataini, writer):
    timeframe_enum = mt5.TIMEFRAME_MN1  # Alteração para time frame mensal
    ...
    # Lógica para calcular resultados mensais
    ...
    # Adicionar uma coluna para o nome do mês
    df_candles["nome_do_mes"] = df_candles["time"].dt.strftime('%B')
